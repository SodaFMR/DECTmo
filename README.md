...
docs/motion-standard.md         Motion command schema and sequence runner
```
...
For predefined movements and the command format expected from future DECT-side control, follow `docs/motion-standard.md`.
